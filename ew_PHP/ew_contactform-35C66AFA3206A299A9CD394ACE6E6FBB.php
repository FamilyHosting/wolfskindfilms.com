<?php /* Copyright 2017-2025 RAGE Software Inc. All Rights Reserved */ 
...
$file_url = "";
$customer_code = "";
$form_code = "58D28FA0AA434BBF933A33136BE83C2CBD69AFDAD6EE4EB28C0416C9779751EA";
$form_name = "My Contact Form";
$emailRecipient = "info@dejanbucin.com";
$submission_id = "";
$strEmailAttachments = "";
...
if ($emailSender == "") {
$emailSender = "info@dejanbucin.com"; }
$remove = ["*",";","\\","}","{","[","]","+","%"];
$replace_with = [];
...
$formPlainText .= "> " . $formField . ": "; 			$emailContent .= "</td>" . $newline;
...
$formPlainText .= preg_replace('/<br\s*\/?>/i', " ", $finalValue) . "\n";
...
if (!is_array($stats)) {
json(['success' => FALSE, 'message' => "Can't get contact form stats"]);
exit;
} else {
...
$errorMsg = "The file could not be uploaded: ".  $upload_errors[$file['error']];
exit;
}
elseif (!$file['error']) {
...
if(!$mail->sendMail($emailRecipient, $emailSender,  $strConfirmationSubject , $confirmationEmail, null, true, "text/plain")) {
